...
imwrite("_intp.png", img_intp * 255.0);  // Save file for quick load when testing other functions 

// Angular interpolation 
Mat img_coordAng = imShiftCoordAng(img);
Mat img_intpAng = interpolateNNAng(img_coordAng, 1);
imwrite("_intpAng.png", img_intpAng * 255.0);  // Save file for quick load when testing other functions 
